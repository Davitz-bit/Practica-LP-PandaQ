...
class EvalVisitor(pandaqVisitor):
	...
	def visitOrdreVarisCamps(self, ctx):
		[ctx_campOrdre1, k_coma, ctx_campOrdre2] = list(ctx.getChildren())
		campOrdre1 = self.visit(ctx_campOrdre1)
		campOrdre2 = self.visit(ctx_campOrdre2)
		return campOrdre1 + campOrdre2
