...
accio		: 'select' camps 'from' par																# seleccionar
			...
			| 'select' camps 'from' par innerjoin													# seleccionarIInnerJoin
			| 'select' camps 'from' par 'where' par 'in' '(' accio ')' 'order' 'by' ordre			# seleccionarISubconsultaOrdenar
			| 'select' camps 'from' par 'where' par 'in' '(' accio ')'								# seleccionarISubconsulta
;
